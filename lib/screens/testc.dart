import 'package:bloodbank/screens/testHome.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Container(
            ...
            decoration:
                BoxDecoration(color: Color.fromARGB(255, 255, 173, 100)),
            child: SingleChildScrollView(
                child: Padding(
                    padding: EdgeInsets.fromLTRB(
                        20, MediaQuery.of(context).size.height * 0.2, 20, 0),
                    child: Column(children: <Widget>[
                      Image.asset("assets/images/trans.png",
                          fit: BoxFit.fitWidth, width: 180, height: 180),
                      const SizedBox(
                        height: 30,
                      ),
