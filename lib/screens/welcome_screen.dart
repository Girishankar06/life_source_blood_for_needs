...
import 'package:bloodbank/screens/testc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          Text('Life Source',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.red),),
          SizedBox(
            height: 40,
          ),
          ...
          Center(
              child:GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => testc()));
                },
                child: Container(
                  width: 180,
                  height: 40,
                  child: Center(child: Text("Test Center",style: TextStyle(color: Colors.blue),)),
                  decoration: BoxDecoration(
                      color: Colors.white,
                      boxShadow: [
                        BoxShadow(color: Colors.blue,spreadRadius: 0.5)
